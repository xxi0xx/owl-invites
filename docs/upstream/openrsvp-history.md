# Archived upstream project history

> [!CAUTION]
> This is the preserved pre-Gate-4 README snapshot and inherited release
> history. It is not current Owl Invites operator guidance, and its commands,
> paths, images, or release claims must not be used for deployment. Historical
> upstream release notes retain their original product name and authorship.

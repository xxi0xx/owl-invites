...
CREATE TABLE instances (
    ...
    allow_signups        INTEGER NOT NULL DEFAULT 0 CHECK(allow_signups IN (0,1)),
...
SELECT
    ...
    CASE WHEN (SELECT value FROM instance_config WHERE key = 'allow_signups') = 'true' THEN 1 ELSE 0 END,
